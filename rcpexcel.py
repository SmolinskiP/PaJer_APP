...
def Generate_Excel(localization, department, month_year):
    ...
    for (imie, nazwisko, id, palacz, umowa, firma, stanowisko) in sql_query_1:
        ...
        worksheet.write_url('A40', "internal:'Spis tresci'!A1", string = "Spis tresci")
        ...
        worksheet.write(1, 5, Get_SQL_Data_Excel("_umowa", "rodzaj", "id", umowa))
        worksheet.write(1, 7, Get_SQL_Data_Excel("_firma", "firma", "id", firma))
        worksheet.write(2, 5, Get_SQL_Data_Excel("_stanowisko", "stanowisko", "id", stanowisko))
...
#Wyjatek dla : 7 - Anna Stanowska, 128 - Anna Smolinska, 21 - Kasia Szydlowska
            if (pracownik == 7 or pracownik == 128 or pracownik == 21 or pracownik == 112):
                cell_type = black_cell
                entry_type = black_cell
                exit_type = black_cell
